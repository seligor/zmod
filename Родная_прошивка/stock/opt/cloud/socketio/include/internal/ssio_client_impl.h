#ifndef SSIO_CLIENT_IMPL_H
#define SSIO_CLIENT_IMPL_H
...
#undef SYNTHESIS_SETTER
        ...
        ssio::socket::ptr const& socket(const std::string& nsp);
    ...
    private:
        ...
        void sockets_invoke_void(void (ssio::socket::*fn)(void));
        ...
        friend class ssio::client;
        friend class ssio::socket;
    };
}
