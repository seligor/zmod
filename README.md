...
## Версия 0.1.5
- Добавлено mainsail. Переключение через мкрос WEB
...
- Исправлена калибровка стола. Тепперь можно установить температуру стола  и экструдера для калибровки. по умолчанию 120/80
- Исправлено отключение экрана в режиме без экрана. Он отключантся через 4 минуты.
