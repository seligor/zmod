...
2. Поместить файл Adventurer5M-zmod*.tgz для обычной версии или Adventurer5MPro-zmod*.tgz для Pro версии в корневую папку USB Flash. <u>Файл получается путем **переименования**</u>.
3. Выключить принтер
