...
3. Дать возможность использовать пользовательский конфиг мунракер
4. Сохранять БД мунракер после  обновления
5. Добавить КАМП после (имеет смысл только после  очистки сопла)
6. При отключении дисплея выводить картинку, что дисплей не работает или просто черный фон
...
2. Поместить файл Adventurer5M-zmod*.tgz или Adventurer5MPro-zmod*.tgz в корневую папку USB Flash
3. Выключить принтер
