...
MD5 сумма `23ada46aaf7e53bec598d42d9af2df6c  Adventurer5MPro-zmod-1.0.3.tgz`

Ставится на чистую версию **не ниже 2.7.5** (2.7.5, 2.7.6, 2.7.7, 2.7.8, 2.7.9)
...
- После обновления fluidd через веб интерфес, необходимо перезагрузить принтер *сова*
